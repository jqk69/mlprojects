...
class DataInjestion:
    ...
    def initiate_data_injestion(self): 
        ...
        try:
            ...
            logging.info("Dataframe Exported...")
            ...
            logging.info("Data splitt initiated...")
            ...
            logging.info("Data split & Injestion completed successfully...")
            return(
...
if __name__=="__main__":
    ...
    train_array,test_array,_=data_transfromation.initiate_data_transformation(train_data,test_data)
